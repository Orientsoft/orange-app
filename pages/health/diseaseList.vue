<template>
	<view>
		<cu-custom :isBack="true" bgColor="bg-white title-orange">
			<block slot="backText"><text class="title-black">常见疾病</text></block>
		</cu-custom>
		...
		<view class="hospital-card-list">
			<view @click="goPagesById('/pages/home/newInfo','disease',item.id)" v-for="(item,index) in newsList" :key="index" class="flex padding-tb-sm card-item">
